...
The result of the power analysis suggests that at least 350 observations per species are needed to make a statistically confident estimate of Cliona prevalence.
...
clionaclean1 <- cliona %>%
  filter(SPP %in% filtered_species$SPP) %>%  # ← filters to power-tested species
